<template>
  ...
  >
    ...
    >
      ...
      >
        <!-- "About Me" => "Home" if on /about -->
        <li class="hover:tracking-[0.3rem] duration-150 hover:text-my-orange-light drop-shadow-lg">
          <NuxtLink :to="isAboutPage ? '/' : '/about'">
            {{ isAboutPage ? 'Home' : 'About Me' }}
          </NuxtLink>
        </li>

        <!-- "Portfolio" => "Home" if on /portfolio -->
        <li class="hover:tracking-[0.3rem] duration-150 hover:text-my-orange-light drop-shadow-lg">
          <NuxtLink :to="isPortfolioPage ? '/' : '/portfolio'">
    ...
    <div
      v-if="mobileMenuOpen"
      class="md:hidden bg-gradient-to-tr from-my-orange-light/70 to-my-orange-dark/50
             backdrop-blur-md text-my-orange-light font-sarpanch uppercase
             tracking-[0.1rem] mx-20 py-10 rounded-4xl drop-shadow-xl"
    >
      <ul class="flex flex-col items-center space-y-8 py-4">
        <!-- Same logic for mobile menu: "About Me" => "Home" if on /about -->
        <li
        ...
        <!-- Same logic for portfolio: "Portfolio" => "Home" if on /portfolio -->
        <li
          class="hover:cursor-pointer hover:tracking-[0.3rem] 
                 duration-150 hover:text-my-orange-light drop-shadow-lg"
          @click="toggleMobileMenu"
...
// If current path is /about => show "Home"
const isAboutPage = computed(() => route.path === '/about')

// If current path is /portfolio => show "Home"
...
<style scoped>
/* Optional: add transitions or custom styling as needed */
</style>
