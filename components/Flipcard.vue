      ...
      >
        ...
        <div
          class="absolute w-full h-full rounded-xl backface-hidden 
                 ...
                 tracking-[0.5rem]"
        >
          <h2 class="text-6xl lg:text-8xl font-light drop-shadow-xl">cvilipić</h2>
        </div>
        ...
        <div
          class="absolute w-full h-full rounded-xl backface-hidden 
                 ...
                 tracking-[0.5rem]"
        >
          <h2 class="text-6xl lg:text-8xl font-light text-center drop-shadow-xl">art & <br> design</h2>
        </div>
      </div>
    </div>
  </template>
